            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button @click="themKhachHang()" type="button" class="btn btn-primary" data-bs-dismiss="modal">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button @click="capNhatKhachHang()" class="btn btn-info" data-bs-dismiss="modal">
...
export default {
    ...
    methods: {
        ...
        themKhachHang() {
            if (!this.khach_hang_create.password || !this.khach_hang_create.re_password) {
                toaster.error("Vui lòng nhập đầy đủ mật khẩu!");
                return;
            }
