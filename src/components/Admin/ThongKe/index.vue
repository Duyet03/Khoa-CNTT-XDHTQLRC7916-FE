            ...
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
              ...
              <div class="d-flex gap-3 align-items-center flex-wrap">
                ...
                <div v-if="selectedPeriod === 'day'" class="date-input">
                  <input type="date" v-model="dateFilters.day" class="form-control" @change="fetchTimeData">
                </div>

                <div v-if="selectedPeriod === 'week'" class="date-input">
                  <input type="date" v-model="dateFilters.week" class="form-control" @change="fetchTimeData">
                </div>

                <div v-if="selectedPeriod === 'month'" class="date-input">
                  <input type="month" v-model="dateFilters.month" class="form-control" @change="fetchTimeData">
                </div>
                ...
                <div v-if="selectedPeriod === 'quarter'" class="d-flex gap-2">
                  ...
                  <input type="number" v-model="dateFilters.quarterYear" class="form-control" placeholder="Năm" @change="fetchTimeData">
                </div>

                <div v-if="selectedPeriod === 'year'" class="date-input">
                  <input type="number" v-model="dateFilters.year" class="form-control" placeholder="Năm" @change="fetchTimeData">
                </div>
              </div>
            </div>
          </div>
          <div class="card-body chart-container">
            <Bar v-if="timeChartLoaded && hasData" 
                 :data="timeChartData" 
...
.total-revenue-card, .total-orders-card {
